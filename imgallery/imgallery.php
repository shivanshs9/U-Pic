...
//=======================================================================================//
  ...
  public function __construct(
  	$thumbsize=128, //Change this to match your thumbnail size
  	$maxsize=640, //Change this to match your maximum image size
  	$folderpath="uploads", //Change this to match your folder path
  	$elements=array()
  ){
  ...
  public function getImageThumbnail($src){
	...
	if(file_exists($cachepath)){ return $cachepath; } //If cached, return right away
